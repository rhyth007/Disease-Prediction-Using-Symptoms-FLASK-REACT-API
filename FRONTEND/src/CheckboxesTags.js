...
export default class Tags extends React.Component {
	constructor(props) {
		...
		this.onPredictchange = this.onPredictchange.bind(this);
	}

	onPredictchange = (event, values) => {
		this.setState(
			{
				prediction: values,
				//prediction1 : values,
	...
	onTagsChange = (event, values) => {
		this.setState(
			...
			() => {
				...
				predict.innerHTML = "";
				const predict1 = document.getElementById("prediction1");
				predict1.innerHTML = "";
			}
		);
	};
	handleSubmit(event) {
		...
		fetch(url, reqOpt)
			...
			.then((respJ) => {
				...
				const predict = document.getElementById("prediction");
				const predict1 = document.getElementById("prediction1");
				//predict.innerHTML = "Disease Detected: <br/> Using  DecisionTree :  "+respJ.prediction +"<br/>" +"Using Random Forest : "+respJ.prediction1;
				predict.innerHTML = "Disease Detected: <br/> " + respJ.prediction;
				//predict1.innerHTML = "Using  KNN :"+respJ.prediction2 +"<br/>" +" Using NB  : "+respJ.prediction3;
			});
	}
			...
			<div style={{ width: 500 }}>
				<div className="dp">
					...
					>
						...
						<strong>
							{" "}
							{this.state.prediction} <br />
							{this.state.prediction1} {this.state.prediction2}{" "}
							{this.state.prediction3}
						</strong>
					</Typography>
				</div>
...
const diseaseData = [
	...
	{ Symptom: "blurred_and_distorted_vision",Title: "Blurred and Distorted Vision",},
	...
	{ Symptom: "pain_during_bowel_movements",Title: "Pain during Bowel Movements",},
	...
	{Symptom: "receiving_blood_transfusion",Title: "Receiving Blood Transfusion",},
	{  Symptom: "receiving_unsterile_injections",Title: "Receiving Unsterile Injections",},
	...
	{Symptom: "history_of_alcohol_consumption",Title: "History of Alcohol Consumption",},
