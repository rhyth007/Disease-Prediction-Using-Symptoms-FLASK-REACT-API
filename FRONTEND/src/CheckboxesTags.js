	...
	handleSubmit(event) {
		...
		fetch(url, reqOpt)
			...
			.then((respJ) => {
				console.log(respJ);
				const predict = document.getElementById("prediction");
				predict.innerHTML = "Disease Detected "+respJ.prediction;
		...
		return (
			<div style={{ width: 500 }}>
				...
				<form onSubmit={this.handleSubmit}>
					...
					<Button style={{ margin: "15px" }}value="Submit"	type="submit" variant="contained"color="secondary">Predict</Button>
				</form>

				<div id="prediction" style={{ margin: "30px", fontWeight: "bolder", color: "#eb144c", fontSize: "40px" }} >
